...
另外，历史验证还证明了：如果不包这层，而是单独拉起一个 `app-server` watcher，它也只能看到自己那条连接里的事件，看不到别的 Codex 会话。相关过程归档在 [`history/codex-approval-notification-session-2026-03-18.md`](./history/codex-approval-notification-session-2026-03-18.md)。
